 ...
 *
 * Renders a single-page A4 payslip with the SpecialCarers brand identity:
...
export async function renderPayslipPdf(data: PayslipData): Promise<Uint8Array> {
  ...
  doc.setProducer("SpecialCarers Payroll");
  ...
  drawText(
    page,
    `${data.employer_name} · Payroll generated by SpecialCarers`,
    margin,
    40,
    7,
    fontReg,
