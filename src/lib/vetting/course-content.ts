...
In the **UK**, report concerns to your local authority's Adult Safeguarding hub (every council has one) and to SpecialCarer's trust and safety team via the in-app SOS or by emailing hello@specialcarers.com. If the person is in immediate danger, call **999**.
