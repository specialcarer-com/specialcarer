...
Always document what you saw, when, and what was said in the carer journal — facts only, your opinions go in private notes. Never delete or edit the original entry. SpecialCarers will support you through any subsequent investigation.`,
    question:
    ...
    options: [
      ...
      "Make sure the client is safe right now, then report to your local Adult Safeguarding hub (UK) or APS (US) and SpecialCarers trust & safety. Document the facts in the journal.",
  ...
  },
  {
    ...
    bodyMarkdown: `If you care for children on SpecialCarers, safeguarding is your single most important responsibility. A child is anyone under 18. Children depend on adults to keep them safe — your job is to be alert, attentive, and willing to act on a concern, even when the evidence is partial.
...
In the **UK**, you have a professional duty to share concerns with the local authority's Children's Services / MASH (Multi-Agency Safeguarding Hub) and SpecialCarers trust and safety. Refer urgently if a child is at immediate risk; otherwise within 24 hours. NSPCC helpline: 0808 800 5000.

In the **US**, mandatory reporting laws vary by state, but childcare workers are mandated reporters in most states. Report to the state's Child Protective Services (CPS) hotline and to SpecialCarers. National Child Abuse Hotline: 1-800-422-4453.
...
Call **999** (UK) or **911** (US) if you believe a child is in immediate danger.`,
    ...
    options: [
      ...
      "Calmly listen, ask open questions like \"What happens when dad gets angry?\", document her exact words, and refer to MASH (UK) or CPS (US) plus SpecialCarers trust & safety.",
  ...
  },
  {
    ...
    title: "SpecialCarers Platform Policies",
    summary:
      "How bookings, payments, and disputes work — and the rules every carer must follow.",
    bodyMarkdown: `SpecialCarers connects vetted carers with families who need help. As a carer on the platform, here are the policies that protect both sides.
...
**Account standing**: repeated late cancellations, low ratings, safeguarding concerns, off-platform attempts, or failure to keep your DBS / Checkr current can all lead to suspension or permanent removal. Always tell trust and safety first if something goes wrong — we'd rather hear from you early.`,
    ...
    options: [
      ...
      "Ask SpecialCarers for permission to do it just this time.",
    ],
    correctIndex: 1,
  },
  {
    ...
    bodyMarkdown: `Every shift you work on SpecialCarers is a shift in someone's home, on a day where they probably need you because something is hard. The code of conduct is short but absolute.
...
Breaches of the code are reviewed individually. Honesty about a slip-up is always treated more leniently than a cover-up.`,
  ...
  },
  {
    ...
    bodyMarkdown: `Most SpecialCarers shifts are lone-worker shifts: it's just you and the client, often in the client's home. The platform gives you tools — use them.
