...
export default async function VisitingBookPage({
  searchParams,
}: {
      ...
      <div className="pt-10 sm:pt-14 pb-6">
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <p className="mt-2 text-slate-600">
            A carer comes to your home for hourly shifts. Now, scheduled, or
            recurring &mdash; held in escrow until the shift ends.
          </p>
        </div>
      </div>
