                  ...
                  {(r.status === "invited" || r.status === "expired") && (
                    <>
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-xs font-semibold text-[#087C7D] hover:underline disabled:cursor-not-allowed disabled:opacity-50"
                      >
                        {resendingId === r.id && (
                          <span
                            aria-hidden="true"
                      ...
                      {resendErrors[r.id] && (
                        <p role="alert" className="max-w-44 text-right text-xs text-rose-700">
                          {resendErrors[r.id]}
                        </p>
                      )}
                    </>
