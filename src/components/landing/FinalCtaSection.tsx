      ...
      <div className="mx-auto max-w-4xl px-6 py-20 text-center">
        ...
        <div className="mt-10">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-[12px] bg-[#F4A261] px-10 py-4 text-base font-semibold text-[#0F1416] shadow-sm transition hover:bg-[#e7924f] focus:outline-none focus:ring-2 focus:ring-[#F4A261] focus:ring-offset-2 focus:ring-offset-[#0F1416]"
          >
